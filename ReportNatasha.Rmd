...
```{r functions, echo=F, include=FALSE,eval=FALSE}
...
```{r main_all_outcomes, echo=F, include=FALSE,eval=FALSE}
...
```{r main_function, include=FALSE,eval=FALSE}
proc1 <- function()
{
# ---------------- get statistics and pv: --------------------------------
...
```{r main_function_exe, include=FALSE,eval=FALSE}
tb <- list(NA)
